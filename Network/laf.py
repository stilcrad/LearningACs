...
####pytorch
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#20230717sunpenghju  to get fully A ,
...
def get_normalized_affine_shape_A(tilt, angle_in_radians):
    ...
    out_A = torch.bmm(rotmat, torch.bmm(tilt_A, rotmat))
...
def rectifyAffineTransformationUpIsUp(A):
    ...
    A1_ell = torch.cat([(b2a2 / det).contiguous().view(-1,1,1),  det.view(-1,1,1)], dim = 2)
