...
# def DKMv3_outdoor(path_to_weights = "/home/xxx/project/python/DKM-main/experiments/dkm/workspace/checkpoints/train_DKMv3_outdoor_latest77.pth", device=None):
    """
    ...
    if path_to_weights is not None:
        ...
        path_to_weights = "/home/xxx/project/python/DKM-main/weights/DKMv3_outdoor.pth"
        weights = torch.load(path_to_weights, map_location=device)
...
def DKMv3_indoor(path_to_weights = None, device=None):
    ...
    if path_to_weights is not None:
        ...
        path_to_weights = "/home/xxx/project/python/DKM-main/weights/DKMv3_indoor.pth"
        weights = torch.load(path_to_weights, map_location=device)
        # weights = torch.hub.load_state_dict_from_url(weight_urls["DKMv3"]["indoor"],
        #                                              map_location=device)
    return DKMv3(weights, 480, 640, upsample_preds = True, device=device)
