...
from DenseMatch.dkm.utils import get_tuple_transform_ops
from einops import rearrange
from DenseMatch.dkm.utils.local_correlation import local_correlation
...
class RegressionMatcher(nn.Module):
    ...
    def sample(
        ...
        from DenseMatch.dkm.utils.kde import kde
    ...
    def match(
        ...
        *args,
        ...
        if train :
            if not batched:
                b = 1
                w, h = im1.shape[-1] , im1.shape[-2]
                w2, h2 = im2.shape[-1], im2.shape[-2]
