...
from DenseMatch.dkm.utils import get_depth_tuple_transform_ops, get_tuple_transform_ops
import torchvision.transforms.functional as tvf
from DenseMatch.dkm.utils.transforms import GeometricSequential
...
class MegadepthBuilder:
    def __init__(self, data_root="/home/xxx/project/python/DKM-main/data/data1/megadepth") -> None:
        self.data_root = data_root
        self.scene_info_root = os.path.join(data_root, "prep_scene_info")
        # self.all_scenes = os.listdir(self.scene_info_root)
        self.all_scenes = os.listdir("/home/xxx/project/python/DKM-main/data/data1/megadepth/prep_scene_info/")
