...
class ScanNetBuilder:
    def __init__(self, data_root = '/home/xxx/project/python/DKM-main/data/scannet/') -> None:
        self.data_root = data_root
        self.scene_info_root = os.path.join(data_root,'scannet_indices',"scene_data","train")
